...
const PrivacyPolicy = () => (
  <MainLayout>
    <h1>Privacy Policy for Crypto insights</h1>
    <p>
      At cryptoinsights, accessible from https://www.cryptoinsights.space, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document contains types of
      information that is collected and recorded by cryptoinsights and how we use it.
    </p>
    <p>
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in cryptoinsights.
    ...
    <h2>Log Files</h2>
    <p>
      cryptoinsights follows a standard procedure of using log files. These files log visitors when
    ...
    <p>
      Like any other website, cryptoinsights uses 'cookies'. These cookies are used to store
    ...
    <p>
      ...
      cryptoinsights, which are sent directly to users' browser. They automatically receive your IP
    ...
    <p>
      Note that cryptoinsights has no access to or control over these cookies that are used by
      third-party advertisers.
    </p>
    <h2>Third Party Privacy Policies</h2>
    <p>
      cryptoinsights's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>
      cryptoinsights does not knowingly collect any Personal Identifiable Information from children
